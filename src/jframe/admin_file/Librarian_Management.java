...
public class Librarian_Management extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        REGULER.setForeground(new java.awt.Color(153, 255, 255));
        REGULER.setSelected(true);
        REGULER.setText("Reguler");

        buttonGroup2.add(SUSPENDED);
        SUSPENDED.setForeground(new java.awt.Color(153, 255, 255));
        SUSPENDED.setText("Suspended");

        buttonGroup1.add(male);
        male.setForeground(new java.awt.Color(153, 255, 255));
        male.setSelected(true);
        male.setText("Male");

        buttonGroup1.add(female);
        female.setForeground(new java.awt.Color(153, 255, 255));
