...
// verify admin start -----
    ...
    try {
    String sql = "SELECT * FROM employee_data INNER JOIN admin_data ON employee_data.user_id = admin_data.user_id WHERE employee_data.nid = ? and employee_data.dob = ?;";
    ...
    if (rs.next()) {
        ...
        Type = rs.getString("admin_type"); // 
        full_address = rs.getString("full_address");
        status = rs.getString("e_status");
    } else {
        JOptionPane.showMessageDialog(this, "The admin does not exist!"); 
...
// login end  ------
    ...
    private void initComponents() {
        ...
        typetf = new app.bolivia.swing.JCTextField();
        ...
        jPanel2.add(student_type, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 670, 140, 30));
        ...
        typetf.setForeground(new java.awt.Color(51, 255, 51));
        ...
        jPanel2.add(typetf, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 630, 460, 30));

        typelv.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        typelv.setForeground(new java.awt.Color(102, 255, 255));
        typelv.setText("Admin Type :");
...
// TODO add your handling code here:
    ...
    private void rSMaterialButtonCircle1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonCircle1ActionPerformed
        ...
        if (data_valid()){
            if(verify_user()){
                JOptionPane.showMessageDialog(this,"Admin Verifyed!");
                showoutput();
            }
        }
    ...
    private app.bolivia.swing.JCTextField typetf;
