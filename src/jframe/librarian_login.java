...
// verify Librarian start -----
    ...
    if (rs.next()) {
        ...
        JOptionPane.showMessageDialog(this, "The Librarian does not exist!"); 
...
// login end  ------
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Welcome To Librarian Login");
        ...
        jLabel6.setText("Varify Librarian.");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 0, 130, 50));
        ...
        type.setText("Librarian Status :");
        jPanel2.add(type, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 630, 110, 30));
...
// TODO add your handling code here:
    ...
    private void rSMaterialButtonCircle1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonCircle1ActionPerformed
        ...
        if (data_valid()){
            if(verify_user()){
                JOptionPane.showMessageDialog(this,"Librarian Verifyed!");
                showoutput();
            }
        }
