...
// verify Student start -----
    public void showoutput(){
         ...
         instf.setText(ins_office);
         addresstf.setText(full_address);
         idtf.setText(id_of_ins);
    ...
    if (rs.next()) {
        ...
        ins_office =rs.getString("institute_office");
        id_of_ins = rs.getString("ins_office_id");
      ...
      public void valid(){
        ...
        if(rs.next()){
            ...
            if(status.equals("REGULER")){
                ...
                book_issue ah = new book_issue(id);
                ah.setVisible(true);
                this.dispose();  
            }
            else{
                JOptionPane.showMessageDialog(this,"Account Suspended!");
                JOptionPane.showMessageDialog(this,"Feel free to Contact with us for any kind of help.");
            }
...
// login end  ------
    ...
    private void initComponents() {
        ...
        instf = new app.bolivia.swing.JCTextField();
        idtf = new app.bolivia.swing.JCTextField();
        phonetf = new app.bolivia.swing.JCTextField();
        statustf = new app.bolivia.swing.JCTextField();
        ...
        addresstf = new app.bolivia.swing.JCTextField();
        typelv = new javax.swing.JLabel();
        ...
        jLabel4.setText("Welcome To Student Login");
        ...
        jLabel6.setText("Varify Student.");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 0, 120, 50));
        ...
        type.setText("Student Status :");
        jPanel2.add(type, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 670, 100, 30));
        ...
        instf.setBackground(new java.awt.Color(0, 0, 0));
        instf.setBorder(null);
        instf.setForeground(new java.awt.Color(51, 255, 51));
        instf.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        instf.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                instfActionPerformed(evt);
            }
        });
        jPanel2.add(instf, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 550, 460, 30));

        idtf.setEditable(false);
        idtf.setBackground(new java.awt.Color(0, 0, 0));
        idtf.setBorder(null);
        idtf.setForeground(new java.awt.Color(51, 255, 51));
        ...
        jPanel2.add(idtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 590, 160, 30));
        ...
        statustf.setForeground(new java.awt.Color(51, 255, 51));
        ...
        jPanel2.add(statustf, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 670, 140, 30));
        ...
        fulladdressl.setText("ID of institute/office :");
        jPanel2.add(fulladdressl, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 590, 140, 30));

        addresstf.setEditable(false);
        addresstf.setBackground(new java.awt.Color(0, 0, 0));
        addresstf.setBorder(null);
        addresstf.setForeground(new java.awt.Color(51, 255, 51));
        ...
        jPanel2.add(addresstf, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 630, 460, 30));

        typelv.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        typelv.setForeground(new java.awt.Color(102, 255, 255));
        typelv.setText("Full Address :");
        jPanel2.add(typelv, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 630, 100, 30));
...
// TODO add your handling code here:
    ...
    private void instfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_instfActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_instfActionPerformed
    ...
    private app.bolivia.swing.JCTextField addresstf;
    ...
    private app.bolivia.swing.JCTextField idtf;
    private app.bolivia.swing.JCTextField instf;
    ...
    private app.bolivia.swing.JCTextField statustf;
    private app.bolivia.swing.JCTextField student_type1;
    private javax.swing.JLabel type;
    private javax.swing.JLabel typelv;
