...
('root', '[{\"db\":\"library_ms\",\"table\":\"student_history\"},{\"db\":\"library_ms\",\"table\":\"student_book\"},{\"db\":\"library_ms\",\"table\":\"registaed_student_data\"},{\"db\":\"library_ms\",\"table\":\"student_data\"},{\"db\":\"library_ms\",\"table\":\"employee_data\"},{\"db\":\"library_ms\",\"table\":\"employee_history\"},{\"db\":\"library_ms\",\"table\":\"changes_student_data\"},{\"db\":\"library_ms\",\"table\":\"notification\"},{\"db\":\"library_ms\",\"table\":\"book_data\"},{\"db\":\"library_ms\",\"table\":\"book_history\"}]');
...
('root', 'library_ms', 'book_data', '{\"sorted_col\":\"`book_data`.`book_source` ASC\"}', '2024-06-12 07:41:03');
...
('root', '2024-06-25 20:23:10', '{\"Console\\/Mode\":\"collapse\"}');
